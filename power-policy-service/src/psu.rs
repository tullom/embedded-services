...
pub struct PsuEventReceivers<'a, const N: usize, PSU: Lockable, R: Receiver<EventData>>
where
    PSU::Inner: Psu,
{
...
impl<'a, const N: usize, PSU: Lockable, R: Receiver<EventData>> PsuEventReceivers<'a, N, PSU, R>
where
    PSU::Inner: Psu,
{
