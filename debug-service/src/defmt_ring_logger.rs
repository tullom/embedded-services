...
pub async fn defmt_to_host_task() {
    ...
    loop {
        ...
        {
            let msg = HostMsg::Response(HostRequest {
                payload: crate::shared_buffer(),
...
pub async fn no_avail_to_host_task() {
    ...
    let msg = HostMsg::Response(HostRequest {
        payload: no_avail_acpi_buf::get(),
        payload_len: 12,
        command: 0,
        // TODO: Add error status when we actually handle it on the host
        status: 0,
    });
