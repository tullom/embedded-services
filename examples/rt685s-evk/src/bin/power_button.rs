...
async fn main(spawner: Spawner) {
    ...
    spawner.spawn(button_task(button_a, config_a).expect("Failed to spawn button task"));
    spawner.spawn(button_task(button_b, config_b).expect("Failed to spawn button task"));
